...
public class BroomGrowthDefinition implements PlantGrowthDefinition {
    ...
    public BroomGrowthDefinition() {
        ...
        TreeBlockDefinition greenLeaf = new TreeBlockDefinition("PlantPack:BroomLeaf");
        TreeBlockDefinition broomTrunk = new TreeBlockDefinition("PlantPack:BroomTrunk");
        TreeBlockDefinition broomBranch = new TreeBlockDefinition("PlantPack:BroomBranch", true);
        ...
        treeDefinition = new AdvancedLSystemTreeDefinition(ID, "g", replacementMap, blockMap, Arrays.asList(broomTrunk, broomBranch, greenLeaf), 1.5f);
    }
