...
@RegisterPlugin
public class BlueSpruceGrowthDefinition implements PlantGrowthDefinition {
    ...
    public BlueSpruceGrowthDefinition() {
        ...
        TreeBlockDefinition blueSpruceSapling = new TreeBlockDefinition("PlantPack:BlueSpruceSapling");
        TreeBlockDefinition blueSpruceSaplingGenerated = new TreeBlockDefinition(GENERATED_BLOCK);
        TreeBlockDefinition greenLeaf = new TreeBlockDefinition("PlantPack:BlueSpruceLeaf");
        TreeBlockDefinition blueSpruceTrunk = new TreeBlockDefinition("PlantPack:BlueSpruceTrunk");
        TreeBlockDefinition blueSpruceBranch = new TreeBlockDefinition("PlantPack:BlueSpruceBranch", true);
        ...
        treeDefinition = new AdvancedLSystemTreeDefinition(ID, "g", replacementMap, blockMap, Arrays.asList(blueSpruceTrunk, blueSpruceBranch, greenLeaf), 1.5f);
    }
