...
@RegisterPlugin
public class MithrootGrowthDefinition implements PlantGrowthDefinition {
    ...
    public MithrootGrowthDefinition() {
        ...
        TreeBlockDefinition mithrootBranch = new TreeBlockDefinition("PlantPack:MithrootBranch", true);
        ...
        treeDefinition = new AdvancedLSystemTreeDefinition(ID, "g", replacementMap, blockMap, Arrays.asList(mithrootTrunk, mithrootBranch, greenLeaf), 1.5f);
    }
